...
'Banana_Black_spot',
'banana_bunchy_top_virus_(BBTV)' ,'banana_Xanthomonas_wilt_(BXW)','Black_Sigatoka_Disease_Detection' ,'Banana_healthy'
...
def result():
    ...
    pre=''
    if result[0][0] == 1:
        print("Banana_Black_spot")
        out="Banana_Black_spot"
        pre ="Sprays of strobilurin fungicide, kresxim methyl or trifloxystrobin ,Copper-based sprays alone or together with an antibiotic or the chemical mancozeb can be used with moderate efficacy."
    elif result[0][4] == 1:
        print("banana_bunchy_top_virus_(BBTV)")
        out = "banana_bunchy_top_virus_(BBTV)"
        pre = "Liquid copper fungicide sprays can be effective in managing citrus canker and control to a limit"
    elif result[0][5] == 1:
        print("banana_Xanthomonas_wilt_(BXW)")
        out = "banana_Xanthomonas_wilt_(BXW)"
        ...
        print("Banana_healthy")
        out = "Banana_healthy"
        pre = "Banana is Healthy"
    elif result[0][7] == 1:
        print("Black_Sigatoka_Disease_Detection")
        out = "Black_Sigatoka_Disease_Detection"
        pre = "Protectant fungicides based thiram, difenoconazole and chlorothalonil can be used preventively to avoid a widespread infection"
